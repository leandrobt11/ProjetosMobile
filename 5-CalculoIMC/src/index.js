...
const img = 'https://th.bing.com/th/id/OIP.ZQI5P29hwaslTlZ895JWFgHaHa?rs=1&pid=ImgDetMain';
  ...
  return (
    <SafeAreaView>
      <View style={styles.area}>
        ...
        <Button title="Verificar" color="red" fontFamily='cursive' onPress={calculoIMC} />
